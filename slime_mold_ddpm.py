...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default="./output_resized", help='图片序列文件夹路径')
    ...
    parser.add_argument('--save_model', type=str, default='diffusion_model.pth', help='模型保存路径')
