...
def main():
    ...
    parser.add_argument("--input_dir", default="./processed_data_1/output_resized", help="输入文件夹路径")
    parser.add_argument("--output_dir", default="./processed_data_1/balanced", help="输出文件夹路径")
